...
1. Parameters passed into the plugin options.
...
A working sample has been provided in this repository. [View the README](https://github.com/apitraffic/apitraffic-hapi/tree/master/examples/basic) for the sample application for details on how to run it.

## Community

To get started: Star & watch [this repository](https://github.com/apitraffic/apitraffic-hapi) to stay updated on the latest changes.
